...
export const createLanternMaterials = (
  ...
  return {
    ...
    accentMat: lacquerWood(new THREE.Color(frameColor).offsetHSL(0.02, -0.04, 0.1), woodAccentMap, 0.58, 0.28, 0.5),
    trimMat: lacquerWood(new THREE.Color(frameColor).offsetHSL(0.03, -0.08, 0.18), woodTrimMap, 0.48, 0.35, 0.4),
