...
function parseOptions(el: HTMLElement): PhotoLanternOptions {
  ...
  if (el.hasAttribute('paper-color')) options.paperColor = el.getAttribute('paper-color') ?? undefined;
  if (el.hasAttribute('light-color')) options.lightColor = el.getAttribute('light-color') ?? undefined;
  ...
  if (el.hasAttribute('show-accessories')) options.showAccessories = el.getAttribute('show-accessories') !== 'false';
  if (el.hasAttribute('tassel-color')) options.tasselColor = el.getAttribute('tassel-color') ?? undefined;
  ...
  if (el.hasAttribute('initial-angle')) options.initialAngle = Number(el.getAttribute('initial-angle'));
