...
export const demoComponents: Record<string, React.ReactNode> = {
  ...
  SoapBubbles: <C.SoapBubbles width={800} height={500} count={28} />,
  DandelionField: <C.DandelionField width={800} height={500} />,
  LavaBubble: <C.LavaBubble width={800} height={500} />,
  InkBloom: <C.InkBloom width={800} height={500} />,
  AuroraVeil: <C.AuroraVeil width={800} height={500} />,
