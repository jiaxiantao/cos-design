import { PhotoCarousel, type PhotoCarouselItem } from '@/components';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      <PhotoCarousel
        ...
        height={360}
        showCaption
        ariaLabel={t('demos.componentCopy.photoCarouselAria')}
      />
      <p style={{ margin: 0, fontSize: 13, opacity: 0.7 }}>{t('demos.componentCopy.photoCarouselHint')}</p>
    </div>
  );
};

export default PhotoCarouselDemo;
