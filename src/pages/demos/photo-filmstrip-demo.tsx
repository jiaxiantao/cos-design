import { PhotoFilmstrip, type PhotoFilmstripItem } from '@/components';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, width: '100%' }}>
      <PhotoFilmstrip
        ...
        height={280}
        showCaption
        ariaLabel={t('demos.componentCopy.photoFilmstripAria')}
      />
      <p style={{ margin: 0, fontSize: 13, opacity: 0.7 }}>{t('demos.componentCopy.photoFilmstripHint')}</p>
    </div>
  );
};

export default PhotoFilmstripDemo;
