  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      <PhotoLightbox
        ...
        height={480}
        showCaption
        ariaLabel={t('demos.componentCopy.photoLightboxAria')}
      />
      <p style={{ margin: 0, fontSize: 13, opacity: 0.7 }}>{t('demos.componentCopy.photoLightboxHint')}</p>
    </div>
  );
};

export default PhotoLightboxDemo;
