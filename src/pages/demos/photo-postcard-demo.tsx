import { PhotoPostcard, type PhotoPostcardItem } from '@/components';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      <PhotoPostcard
        ...
        height={420}
        showCaption
        ariaLabel={t('demos.componentCopy.photoPostcardAria')}
      />
      <p style={{ margin: 0, fontSize: 13, opacity: 0.7 }}>{t('demos.componentCopy.photoPostcardHint')}</p>
    </div>
  );
};

export default PhotoPostcardDemo;
