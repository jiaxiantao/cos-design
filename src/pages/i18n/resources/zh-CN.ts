...
# 访问 http://localhost:4000`
  ...
  backgroundDemo: {
    ...
    headlines: {
      ...
      SmokeFog: '烟雾缓缓散开',
      BubbleField: '气泡从深海浮起',
      SoapBubbles: '肥皂泡在天空飞舞',
      DandelionField: '绒毛随风播种',
      LavaBubble: '岩浆鼓起又破裂',
      InkBloom: '一滴墨染开清水',
      AuroraVeil: '极光如绸缎垂落',
      MatrixRain: '数字雨倾泻而下',
    ...
    subtitles: {
      ...
      SoapBubbles: '虹彩薄膜缓缓飘飞，点击爆裂成细小水珠',
      DandelionField: '滑动吹散绒毛，点击整朵炸开后重生',
      LavaBubble: '湖面不定期随机鼓起闷裂，也可点击指定位置',
      InkBloom: '点击滴墨溶开，墨量会把水逐渐染深；拖拽可搅动',
      AuroraVeil: '鼠标弯曲光带，点击爆发能量脉冲',
