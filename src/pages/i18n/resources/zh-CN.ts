const zhCN = {
  ...
  home: {
    ...
    aiTitle: '用 AI 搭活动页',
    aiDesc:
      'Cursor、Claude Code、Copilot、Codex 等工具已支持 cos-design — 复制规则或示例提示词即可开始。',
    aiCta: '查看 AI 接入指南 →',
  },
  catalog: {
    title: '组件目录',
  ...
  quickstart: {
    ...
    categoriesDesc:
      '共 {{components}} 个组件，按场景分为 {{categories}} 类。点击左侧导航进入演示，或',
...
# 访问 http://localhost:4000`,
  ...
  demos: {
    ...
    weather: {
      ...
      statusSuccess:
        '{{city}}实况：{{weather}} · {{time}} · {{wind}}级风（{{speed}} km/h）{{extra}} · WMO {{code}}',
      statusTime: '时刻 {{time}}',
      statusDay: '☀️ 白天',
      statusNight: '🌙 夜晚',
