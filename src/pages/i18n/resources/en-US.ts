...
# Open http://localhost:4000`,
  ...
  backgroundDemo: {
    ...
    headlines: {
      ...
      SoapBubbles: 'Soap bubbles drifting in the sky',
      DandelionField: 'Seeds riding the wind',
      LavaBubble: 'Lava swelling then bursting',
      InkBloom: 'A drop of ink blooming in clear water',
      AuroraVeil: 'Aurora curtains hanging in the night',
    ...
    subtitles: {
      ...
      SoapBubbles: 'Iridescent film drifts by; click to pop into tiny droplets',
      DandelionField: 'Sweep to blow seeds, click to burst a head, then watch new buds grow',
      LavaBubble: 'Blisters swell and burst at random; click to raise one at a point',
      InkBloom: 'Click to drop ink; dissolved ink gradually dyes the water darker. Drag to stir',
      AuroraVeil: 'The cursor bends the veils; a click bursts an energy pulse',
